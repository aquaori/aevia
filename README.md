...
| 开启GPU+CPU4x降频 | 44.8  | 249.1 | 458.3  |
| 关闭GPU+CPU满频   | 9.7   | 142.8 | 281.1  |
| 关闭GPU+CPU4x降频 | 42.2  | 636.9 | 1258.3 |

### 内存开销

| 环境              | 1万点常驻 | 5万点常驻 | 10万点常驻 |
| ----------------- | --------- | --------- | ---------- |
| 开启GPU+CPU满频   | 16.2      | 36.5      | 57.4       |
| 开启GPU+CPU4x降频 | 16.1      | 36.2      | 57.0       |
| 关闭GPU+CPU满频   | 16.2      | 36.5      | 57.3       |
| 关闭GPU+CPU4x降频 | 16.1      | 36.2      | 57.0       |

### 操作响应延迟

| 环境              | 本地渲染跟手性 (ms) | 跨端分发展示均值 (ms) |
| ----------------- | ------------------- | --------------------- |
| 开启GPU+CPU满频   | -1.0                | 3.0                   |
...
| 环境              | 页面UI最长阻塞期 (ms) | 抗压持续渲染均值 (FPS) |
| ----------------- | --------------------- | ---------------------- |
| 开启GPU+CPU满频   | 10.2                  | 58.5                   |
| 开启GPU+CPU4x降频 | 36.5                  | 46.2                   |
| 关闭GPU+CPU满频   | 16.4                  | 52.1                   |
| 关闭GPU+CPU4x降频 | 44.8                  | 39.4                   |
